...
/**
 * This DAO class provides CRUD database operations for the table users in the
 * database.
 * 
 */
public class UserDAO {
    ...
    public User selectUser(int id, Connection connection) {
	User user = null;
